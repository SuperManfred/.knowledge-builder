...
- You ARE maintaining and improving the curation system so that operational agents (reading `.knowledge-builder/curated-code-repo-builder/PROMPT.md`) produce analysis‑driven, high‑quality, code‑only curations automatically.
...
1. Read `.knowledge-builder/curated-code-repo-builder/CONTEXT.md` — Understand vision and goals (IMMUTABLE - never modify)
2. Read `.knowledge-builder/curated-code-repo-builder/CONSTRAINTS.md` — Learn invariants and rules (IMMUTABLE - never modify)
3. Read `/Users/MN/AGENTS.md`, `/Users/MN/GITHUB/AGENTS.md` — General agent guidelines

SCOPE OF WORK
1) Audit current system and outputs
   - Read: `.knowledge-builder/curated-code-repo-builder/PROMPT.md`, `_template/*`, `tools/*`
   - Validate every project under `.knowledge-builder/curated-code-repo-builder/projects/*`:
   ...
   - Compare snapshots vs curated decisions:
     - Use `.knowledge-builder/curated-code-repo-builder/snapshots/<owner>-<repo>/<commit>/github-api-tree.json` as source of truth
...
2) Refine the operational prompt and templates
   - Update `.knowledge-builder/curated-code-repo-builder/PROMPT.md` to enforce CONSTRAINTS.md invariants
...
OUTPUTS (Builder)
- Updated `.knowledge-builder/curated-code-repo-builder/PROMPT.md`, `_template/*`, `tools/*` aligned with CONTEXT.md and CONSTRAINTS.md
- Archived previous PROMPT.md in `CHANGELOG/YYYY-MM-DD/`
- Audit report under `.knowledge-builder/curated-code-repo-builder/AUDIT-{date}.md` listing issues and changes

FORBIDDEN ACTIONS (Builder)
- NEVER modify `.knowledge-builder/curated-code-repo-builder/CONTEXT.md` or `.knowledge-builder/curated-code-repo-builder/CONSTRAINTS.md`
- NEVER modify `.knowledge-builder/curated-code-repo-builder/projects/*` or `.knowledge-builder/curated-code-repo-builder/snapshots/*`
- NEVER write to `.knowledge/curated-code-repo/` directly
- NEVER violate invariants defined in CONSTRAINTS.md
- NEVER create Markdown manifests in `.knowledge/curated-code-repo/` (code-only per CONSTRAINTS.md)
